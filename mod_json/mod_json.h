...
#ifndef __MOD_JSON_H__
#define __MOD_JSON_H__

#include "mod_hashtab.h"

#if defined(__cplusplus)
extern "C" {
#endif

#define MOD_JSON_FALSE  ((mod_json_boolean_t)0)
#define MOD_JSON_TRUE   ((mod_json_boolean_t)1)
    ...
    typedef mod_size_t              mod_json_size_t;
    typedef mod_ssize_t             mod_json_ssize_t;
    typedef mod_bool_t              mod_json_boolean_t;
    typedef mod_char_t              mod_json_char_t;
    typedef mod_cchar_t             mod_json_cchar_t;
    typedef mod_uchar_t             mod_json_uchar_t;
    typedef long long               mod_json_integer_t;
    typedef double                  mod_json_float_t;
    typedef void *                  mod_json_pvoid_t;
    typedef mod_list_head_t         mod_json_list_t;
    typedef mod_hashtab_t           mod_json_htab_t;
    typedef mod_hashhead_t          mod_json_hhead_t;
    typedef mod_hashnode_t          mod_json_hnode_t;
     ...
     */
    typedef int (*mod_json_event_proc)(
        mod_json_token_t *tok, mod_json_pvoid_t val, mod_json_size_t len
        );
    ...
    {
        mod_json_list_t      link;
        mod_json_hnode_t     node;
        mod_json_size_t      hash;
    ...
    struct mod_json_object
    {
        ...
        mod_json_htab_t      htab;
        mod_json_list_t      list;
    };
...
#define MOD_JSON_SQUOTE    0x0008  /* Enable single quotes support */
     ...
     *  \param obj       The value to be assigned
     */
    void mod_json_value_assign_object(
        mod_json_value_t *val, mod_json_object_t *obj
        );
     ...
     *  \param arr       The value to be assigned
     */
    void mod_json_value_assign_array(
        mod_json_value_t *val, mod_json_array_t *arr
        );
     ...
     *  \param str       The value to be assigned
     */
    void mod_json_value_assign_string(
        mod_json_value_t *val, mod_json_string_t *str
        );
     ...
     *  \param num       The value to be assigned
     */
    void mod_json_value_assign_integer(
        mod_json_value_t *val, mod_json_integer_t num
        );
     ...
     *  \param dbl       The value to be assigned
     */
    void mod_json_value_assign_float(
        mod_json_value_t *val, mod_json_float_t dbl
        );
     ...
     *  \param bol       The value to be assigned
     */
    void mod_json_value_assign_boolean(
        mod_json_value_t *val, mod_json_boolean_t bol
        );
     ...
     */
    mod_json_boolean_t mod_json_value_is_equal(
        mod_json_value_t *lhs, mod_json_value_t *rhs
        );
     ...
     */
    static inline
    mod_json_value_t *mod_json_value_get(mod_json_value_t *val)
    {
        ++val->refer;
        return val;
    }
     ...
     */
    static inline
    mod_json_ssize_t mod_json_value_put(mod_json_value_t *val)
    {
        return (--val->refer);
    }
     ...
     */
    static inline
    mod_json_ssize_t mod_json_value_refer(mod_json_value_t *val)
    {
     ...
     */
    static inline
    void mod_json_value_set_leaked(mod_json_value_t *val)
    {
        val->refer = 0;
    }
     ...
     */
    static inline
    mod_json_boolean_t mod_json_value_is_leaked(mod_json_value_t *val)
    {
        return (val->refer <= 0);
    }
     ...
     */
    static inline
    mod_json_boolean_t mod_json_value_is_shared(mod_json_value_t *val)
    {
        return (val->refer > 1);
    }
     ...
     */
    static inline
    mod_json_value_t *mod_json_value_grab(mod_json_value_t *val)
    {
        /* Is it leaked? */
     ...
     */
    static inline
    mod_json_type_t mod_json_value_type(mod_json_value_t *val)
    {
        return (val->type);
    }
     ...
     */
    static inline
    mod_json_boolean_t mod_json_value_is_null(mod_json_value_t *val)
    {
     ...
     */
    static inline
    mod_json_boolean_t mod_json_value_is_array(mod_json_value_t *val)
    {
     ...
     */
    static inline
    mod_json_boolean_t mod_json_value_is_object(mod_json_value_t *val)
    {
     ...
     */
    static inline
    mod_json_boolean_t mod_json_value_is_string(mod_json_value_t *val)
    {
     ...
     */
    static inline
    mod_json_boolean_t mod_json_value_is_float(mod_json_value_t *val)
    {
     ...
     */
    static inline
    mod_json_boolean_t mod_json_value_is_boolean(mod_json_value_t *val)
    {
     ...
     */
    static inline
    mod_json_boolean_t mod_json_value_is_integer(mod_json_value_t *val)
    {
     ...
     *  \return          Null indicates failure.
     */
    mod_json_string_t *mod_json_string_set(
     ...
     *  \return          0 indicates success, -1 indicates failure.
     */
    int mod_json_string_assign(
        mod_json_string_t *str, mod_json_cchar_t *cstr, mod_json_size_t len
        );
     ...
     */
    static inline
    mod_json_string_t *mod_json_string_clone(mod_json_string_t *str)
    {
        return (str 
            ? mod_json_string_set(
                str->first, (mod_size_t)(str->last - str->first)
                ) 
            : (mod_json_string_t*)0
            );
    }
     ...
     *  \return          0 indicates success, -1 indicates failure.
     */
    int mod_json_string_add(
        mod_json_string_t *str, mod_json_string_t *val
        );
     ...
     */
    int mod_json_string_compare(
        mod_json_string_t *str1, mod_json_string_t *str2
        );
     ...
     */
    static inline
    mod_json_string_t *mod_json_string_get(mod_json_string_t *str)
    {
        ++str->refer;
        return str;
    }
     ...
     */
    static inline
    mod_json_ssize_t mod_json_string_put(mod_json_string_t *str)
    {
        return (--str->refer);
    }
     ...
     */
    static inline
    mod_json_ssize_t mod_json_string_refer(mod_json_string_t *str)
    {
     ...
     */
    static inline
    void mod_json_string_set_leaked(mod_json_string_t *str)
    {
        str->refer = 0;
    }
     ...
     */
    static inline
    mod_json_boolean_t mod_json_string_is_leaked(mod_json_string_t *str)
    {
        return (str->refer <= 0);
    }
     ...
     */
    static inline
    mod_json_boolean_t mod_json_string_is_shared(mod_json_string_t *str)
    {
        return (str->refer > 1);
    }
     ...
     */
    static inline
    mod_json_string_t *mod_json_string_grab(mod_json_string_t *str)
    {
        /* Is it leaked? */
     ...
     */
    static inline
    mod_json_cchar_t *mod_json_string_cstr(mod_json_string_t *str)
    {
     ...
     */
    static inline
    mod_json_char_t *mod_json_string_data(mod_json_string_t *str)
    {
     ...
     */
    static inline
    mod_json_size_t mod_json_string_capacity(mod_json_string_t *str)
    {
     ...
     */
    static inline
    mod_json_size_t mod_json_string_length(mod_json_string_t *str)
    {
     ...
     */
    static inline
    mod_json_boolean_t mod_json_string_empty(mod_json_string_t *str)
    {
     ...
     *  \return          1 indicates true, 0 indicates false.
     */
    mod_json_boolean_t mod_json_array_is_equal(
        mod_json_array_t *lhs, mod_json_array_t *rhs
        );
     ...
     */
    static inline
    mod_json_array_t *mod_json_array_get(mod_json_array_t *arr)
    {
        ++arr->refer;
        return arr;
    }
     ...
     */
    static inline
    mod_json_ssize_t mod_json_array_put(mod_json_array_t *arr)
    {
        return (--arr->refer);
    }
     ...
     */
    static inline
    mod_json_ssize_t mod_json_array_refer(mod_json_array_t *arr)
    {
     ...
     */
    static inline
    void mod_json_array_set_leaked(mod_json_array_t *arr)
    {
        arr->refer = 0;
    }
     ...
     */
    static inline
    mod_json_boolean_t mod_json_array_is_leaked(mod_json_array_t *arr)
    {
        return (arr->refer <= 0);
    }
     ...
     */
    static inline
    mod_json_boolean_t mod_json_array_is_shared(mod_json_array_t *arr)
    {
        return (arr->refer > 1);
    }
     ...
     */
    static inline
    mod_json_array_t *mod_json_array_grab(mod_json_array_t *arr)
    {
        /* Is it leaked? */
     ...
     */
    static inline
    mod_json_size_t mod_json_array_count(mod_json_array_t *arr)
    {
     ...
     */
    static inline
    mod_json_size_t mod_json_array_capacity(mod_json_array_t *arr)
    {
     ...
     */
    static inline
    mod_json_boolean_t mod_json_array_empty(mod_json_array_t *arr)
    {
     ...
     */
    static inline
    mod_json_value_t **mod_json_array_begin(mod_json_array_t *arr)
    {
        return (arr->first);
    }
     ...
     */
    static inline
    mod_json_value_t **mod_json_array_rbegin(mod_json_array_t *arr)
    {
        return (arr->last - 1);
    }
     ...
     */
    static inline
    mod_json_value_t **mod_json_array_end(mod_json_array_t *arr)
    {
        return (arr->last);
    }
     ...
     */
    static inline
    mod_json_value_t **mod_json_array_rend(mod_json_array_t *arr)
    {
        return (arr->first - 1);
    }
     ...
     *  \return          0 indicates success, -1 indicates failure.
     */
    int mod_json_array_push(
        mod_json_array_t *arr, mod_json_value_t *val
        );
     ...
     */
    mod_json_value_t *mod_json_array_at(
        mod_json_array_t *arr, mod_json_size_t id
        );
    ...
    int mod_json_array_resize(
        mod_json_array_t *arr, mod_json_size_t n, mod_json_value_t *val
        );
     ...
     */
    static inline
    mod_json_string_t *mod_json_pair_key(mod_json_pair_t *pair)
    {
        return (pair->key);
    }
     ...
     */
    static inline
    mod_json_value_t *mod_json_pair_value(mod_json_pair_t *pair)
    {
        return (pair->val);
    }

    /**
     *  \brief           Retrieve next node of a JSON pair
     *  \param pair      The pointer of pair
     *  \return          The next pointer of pair
     */
    static inline
    mod_json_pair_t *mod_json_pair_next(mod_json_pair_t *pair)
    {
        return ((mod_json_pair_t*)pair->link.next);
    }

    /**
     *  \brief           Retrieve previous node of a JSON pair
     *  \param pair      The pointer of pair
     *  \return          The previous pointer of pair
     */
    static inline
    mod_json_pair_t *mod_json_pair_prev(mod_json_pair_t *pair)
    {
        return ((mod_json_pair_t*)pair->link.prev);
    }
     ...
     *  \return          1 indicates true, 0 indicates false.
     */
    mod_json_boolean_t mod_json_object_is_equal(
        mod_json_object_t *lhs, mod_json_object_t *rhs
        );
     ...
     */
    static inline
    mod_json_object_t *mod_json_object_get(mod_json_object_t *obj)
    {
        ++obj->refer;
        return obj;
    }
     ...
     */
    static inline
    mod_json_ssize_t mod_json_object_put(mod_json_object_t *obj)
    {
        return (--obj->refer);
    }
     ...
     */
    static inline
    mod_json_ssize_t mod_json_object_refer(mod_json_object_t *obj)
    {
     ...
     */
    static inline
    void mod_json_object_set_leaked(mod_json_object_t *obj)
    {
        obj->refer = 0;
    }
     ...
     */
    static inline
    mod_json_boolean_t mod_json_object_is_leaked(mod_json_object_t *obj)
    {
        return (obj->refer <= 0);
    }
     ...
     */
    static inline
    mod_json_boolean_t mod_json_object_is_shared(mod_json_object_t *obj)
    {
        return (obj->refer > 1);
    }
     ...
     */
    static inline
    mod_json_object_t *mod_json_object_grab(mod_json_object_t *obj)
    {
        /* Is it leaked? */
     ...
     */
    static inline
    mod_json_size_t mod_json_object_count(mod_json_object_t *obj)
    {
     ...
     */
    static inline
    mod_json_boolean_t mod_json_object_empty(mod_json_object_t *obj)
    {
     ...
     */
    static inline
    mod_json_pair_t *mod_json_object_begin(mod_json_object_t *obj)
    {
        return ((mod_json_pair_t*)obj->list.next);
    }
     ...
     */
    static inline
    mod_json_pair_t *mod_json_object_rbegin(mod_json_object_t *obj)
    {
        return ((mod_json_pair_t*)obj->list.prev);
    }
     ...
     */
    static inline
    mod_json_pair_t *mod_json_object_end(mod_json_object_t *obj)
    {
        return ((mod_json_pair_t*)&obj->list);
    }
     ...
     */
    static inline
    mod_json_pair_t *mod_json_object_rend(mod_json_object_t *obj)
    {
        return ((mod_json_pair_t*)&obj->list);
    }
     ...
     */
    mod_json_pair_t *mod_json_object_insert(
        mod_json_object_t *obj, mod_json_string_t *key, mod_json_value_t *val
        );
     ...
     */
    mod_json_pair_t *mod_json_object_assign(
        mod_json_object_t *obj, mod_json_string_t *key, mod_json_value_t *val
        );
     ...
     */
    mod_json_pair_t *mod_json_object_touch(
        mod_json_object_t *obj, mod_json_cchar_t *key
        );
     ...
     *  \return          Null indicates failure.
     */
    mod_json_value_t *mod_json_object_at(
        mod_json_object_t *obj, mod_json_cchar_t *key
        );
     ...
     *  \return          Null indicates failure.
     */
    mod_json_pair_t *mod_json_object_find(
        mod_json_object_t *obj, mod_json_cchar_t *key
        );
     ...
     */
    void mod_json_token_set_param(
        mod_json_token_t *tok, mod_json_pvoid_t param
        );
     ...
     */
    void mod_json_token_set_event(
        mod_json_token_t *tok, mod_json_event_proc proc
        );
     ...
     */
    mod_json_value_t *mod_json_parse(
...
#if defined(__cplusplus)
#include "mod_json.hh"  /* includes C++ interface */
#endif

#endif /*__MOD_JSON_H__*/
